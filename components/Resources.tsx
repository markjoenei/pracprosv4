    ...
    overlay: (
      <div className="absolute bottom-4 left-4 right-4 rounded-2xl bg-white/95 p-3 shadow-card backdrop-blur">
        <div className="flex items-center gap-2">
          <span className="grid h-6 w-6 place-items-center rounded-full bg-emerald-500 text-[10px] font-bold text-white">P</span>
  ...
  },
  {
    ...
    overlay: (
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
        <div className="relative grid h-16 w-16 place-items-center rounded-full bg-rose-500 text-white shadow-[0_18px_30px_-10px_rgba(244,63,94,0.6)]">
    ...
    overlay: (
      <div className="absolute bottom-4 left-4 right-4 space-y-1.5">
        ...
        <div className="ml-auto inline-flex max-w-[80%] items-center gap-1.5 rounded-2xl rounded-br-sm px-2.5 py-1.5 text-[11.5px] text-white shadow-card"
          style={{ background: "linear-gradient(135deg, #5ea9d4, #5b48c0)" }}
        >
    ...
    overlay: (
      <div className="absolute bottom-4 left-4 right-4">
        <div className="rounded-2xl bg-ink/90 p-3 text-white backdrop-blur shadow-card">
          <div className="flex items-center gap-2">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden className="text-rose-400">
          ...
          <div className="mt-1 flex items-center justify-between">
            ...
            <span className="rounded-full bg-emerald-500 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider">
              Auto
            </span>
          </div>
        </div>
              ...
              <div key={i} className="flex flex-1 items-center gap-1">
                <span
                  className={`grid h-5 w-5 shrink-0 place-items-center rounded-full text-[9.5px] font-bold ${
                    s.on ? "bg-violet-500 text-white" : "bg-ink/10 text-ink-soft"
                  }`}
                >
                  {i + 1}
                </span>
                {i < 4 ? <span className={`h-px flex-1 ${s.on ? "bg-violet-300" : "bg-ink/10"}`} /> : null}
              </div>
            ))}
          </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(243,112,33,0.45), transparent 70%)",
        }}
      />
      <div
        aria-hidden
      ...
      <div className="container-page relative">
          ...
          <div>
            ...
            <h2 className="mt-5 font-display text-4xl md:text-5xl lg:text-[64px] leading-[1.04] font-semibold tracking-[-0.028em] text-white">
              ...
              <span className="relative inline-block">
                <span className="relative z-10 italic" style={{ color: "#F37021" }}>First Office</span>
                <span
                  aria-hidden
          ...
          <div className="relative mx-auto w-full max-w-[520px]">
            <div className="relative aspect-[4/5] w-full">
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(60% 60% at 50% 50%, rgba(243,112,33,0.30), transparent 70%)",
                }}
              />
              ...
              >
                ...
                <div className="mt-2 inline-flex items-center gap-1.5 rounded-full bg-emerald-50 px-2 py-0.5 text-[10.5px] font-semibold text-emerald-700">
        ...
        <div className="mt-16 md:mt-20 grid gap-5 sm:grid-cols-4 lg:grid-cols-6">
          {channels.map((c) => (
            <article
              key={c.title}
              className={`group relative flex flex-col overflow-hidden rounded-3xl border border-white/15 bg-white/[0.04] backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-white/25 hover:bg-white/[0.06] hover:shadow-[0_30px_60px_-20px_rgba(0,0,0,0.6)] ${c.span}`}
            >
              {/* Image layer */}
              ...
              <div className="relative flex flex-1 flex-col gap-3 p-6">
                ...
                />
                <h3 className="font-display text-[20px] md:text-[22px] font-semibold tracking-tight text-white leading-snug">
                  {c.title}
                </h3>
          ...
          {/* Closer CTA card */}
          <article className="group relative flex flex-col justify-between overflow-hidden rounded-3xl border border-white/15 p-7 transition-all duration-300 hover:-translate-y-1 sm:col-span-4 lg:col-span-6"
            style={{
              background:
                "linear-gradient(135deg, rgba(243,112,33,0.18) 0%, rgba(91,72,192,0.18) 100%)",
          ...
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(243,112,33,0.5), transparent 70%)",
              }}
            />
            <div
              aria-hidden
            ...
            <div className="relative flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
              <div className="max-w-2xl">
                <span className="inline-flex items-center gap-1.5 rounded-full border border-white/25 bg-white/10 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wider text-white/95 backdrop-blur">
                  <span
                    className="h-1.5 w-1.5 rounded-full animate-pulse"
                ...
                <h3 className="mt-4 font-display text-[24px] md:text-[28px] font-semibold tracking-tight leading-snug text-white">
                  See how fast PracPros responds —{" "}
                  <span className="text-white/80">to a real lead in your market.</span>
                </h3>
              </div>
              <Button
                href="#growth-audit"
                ...
                size="lg"
                trailingIcon
                className="!bg-white !text-ink hover:!bg-white shadow-[0_18px_40px_-18px_rgba(255,255,255,0.4)]"
              >
                Get a Free Audit
              </Button>
            </div>
